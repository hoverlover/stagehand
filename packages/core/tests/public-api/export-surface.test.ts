...
const publicApiShape = {
  ...
  FilesystemAdapter: Stagehand.FilesystemAdapter,
  GCSAdapter: Stagehand.GCSAdapter,
  InMemoryAdapter: Stagehand.InMemoryAdapter,
  LLMClient: Stagehand.LLMClient,
  LOG_LEVEL_NAMES: Stagehand.LOG_LEVEL_NAMES,
  NullAdapter: Stagehand.NullAdapter,
